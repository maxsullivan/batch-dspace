...
PDFPATH=/home/sullivm1/RTD/EXAMS/Input/PDF
...
IFS="|"
cat courses2019-edited.csv | while  read ID X1 X2 SUBJECT X3 SHORT_TITLE TITLE_EN X4 SCHOOL X4 FACULTY APPROVAL LECTURER 
...
#    then
    ...
    # titles
            ...
            then
                echo "<dcvalue element=\"title\">"$SUBJECT: $SHORT_TITLE: $TITLE_MI / $TITLE_EN"</dcvalue>" >> ./imports/$ID/dublin_core.xml
            else
                echo "<dcvalue element=\"title\">"$SUBJECT: $SHORT_TITLE: $TITLE_EN"</dcvalue>" >> ./imports/$ID/dublin_core.xml
            fi
            ...
            then
                ...
                echo "<dcvalue element=\"subject\" qualifier=\"course\" language=\"en_NZ\">exam</dcvalue>" >> ./imports/$ID/dublin_core.xml
            fi
            if [ "$YEAR" -a "$YEAR" != "-"  ]
            then
